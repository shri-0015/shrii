...
<head>
    ...
    <title>LOGIN | Simple Online Food Ordering System</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Simple Online Food Ordering System</h3>
            ...
            <div class="card-body">
                <form action="" id="login-form">
                    ...
                    <div class="form-group d-flex w-100 justify-content-between">
                        <a href="./attendance.php">Go to Public Side</a>
